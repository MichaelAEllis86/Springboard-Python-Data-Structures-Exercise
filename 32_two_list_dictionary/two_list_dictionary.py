def two_list_dictionary(keys, values):
    ...
    If there are fewer keys, ignore remaining values:
        ...
        {'a': 1, 'b': 2, 'c': 3}
   """
    keys_and_values={keys[x]:values[x] for x in range (len(keys))}
    return keys_and_values
    
    # keys_dict={key:0 for key in keys}
    # print(keys_dict)
    # keys_and_values={key:values for key in keys_dict}
    # return keys_and_values
    #looks like we could use dict comprehensions here

    #answer from spring board
    # out = {}
